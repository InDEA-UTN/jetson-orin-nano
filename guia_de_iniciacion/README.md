...
| 05 | `05_instalacion_en_ssd_nvme.md` | Montar el SSD M.2, poner la placa en modo *force recovery* y flashear a NVMe desde la PC anfitriona con SDK Manager. Verificación del arranque desde SSD y swap. | Pendiente — espera al disco |
